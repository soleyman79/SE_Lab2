...
در ادامه می‌خواهیم کلاس مستطیل را تبدیل به کلاسی تغییرپذیر (mutable) کنیم. به این منظور، چون از TDD پیروی می‌کنیم، ابتدا تست‌های متدهای setter و getter را برای طول و عرض مستطیل نوشته و سپس آنها را تعریف می‌کنیم. بدیهی است که پیش از پیاده‌سازی method ها، تست‌ها رد می‌شوند.
...
حال در قسمت دوم به سراغ کلاس مربع می‌رویم. مشابه با قسمت قبل، قبل از پیاده‌سازی متدهای این کلاس، تست‌های مربوطه را می‌نویسیم که در همان ابتدا هم رد می‌شوند.
